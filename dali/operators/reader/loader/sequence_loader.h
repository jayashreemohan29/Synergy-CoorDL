...
#ifndef DALI_OPERATORS_READER_LOADER_SEQUENCE_LOADER_H_
#define DALI_OPERATORS_READER_LOADER_SEQUENCE_LOADER_H_
...
#endif  // DALI_OPERATORS_READER_LOADER_SEQUENCE_LOADER_H_
